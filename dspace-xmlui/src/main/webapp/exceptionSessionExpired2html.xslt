...
<!-- This stylesheet to handle exception display is a modified version of
                                    ...
                                    <fieldset xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns="http://di.tamu.edu/DRI/1.0/" class="wordbreak">
                                        <ol class="unstyled">
                                            <li class="control-group">
                                                <div>
                                                    <h5>
                                                        In case that there are other problems, please contact the
                                                        <a target="_blank">
                                                            <xsl:attribute name="href">
                                                                <xsl:value-of select="$contextPath" />
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a data-toggle="collapse" class="accordion-toggle" href="#cocoon-stacktrace">
                                                <span class="label label-warning">Cocoon stacktrace</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a data-toggle="collapse" class="accordion-toggle" href="#java-stacktrace">
                                                <span class="label label-warning">JAVA stacktrace</span>
                                            </a>
                                        </div>
