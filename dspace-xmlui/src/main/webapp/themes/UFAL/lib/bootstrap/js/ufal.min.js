...
jQuery(document)
    ...
    function () {
        ...
        jQuery('div#files_section > h4').append(jQuery('<a class="label label-info" href="#" style="display:block; text-decoration:none;"><i class="fa fa-download">&nbsp;</i>' + jQuery.i18n._('Download instructions for command line') + '</a>').click(function(e){
            e.preventDefault();
            var jqFilesLinks = $("a.filebutton[href*='bitstream']");
            var baseUrl = jqFilesLinks.prop('href');
            baseUrl = baseUrl.substring(0,baseUrl.lastIndexOf("/"))
            var command = "#Don't count on this working long term\ncurl --remote-name-all " + baseUrl + "{";
            ...
            if(jqCommand.length === 0){
                jqCommand = jQuery("<div id='command-div' style='display:none;'>").append(jQuery("<pre style='background-color:black; color:white;'>").text(command));
