...
jQuery(document)
    ...
    function () {
    	...
    	if(!ufal.utils.isCookieExist("cookie-message", "hide")) {
    		var footer = jQuery("<div id='cookie-div' style='z-index: 100; position: fixed; bottom: 0; width: 100%; background-color: #FEEFB3; opacity: 0.9; border-top: 1px solid #C0C0C0; display: none;'>" +
    					"<div class='container' style='padding: 10px; font-weight: bold; color: #333333;'>" +
    						...
    						"</div>" +
    						"<div class='col-md-4'>" +
    							"<a id='hide-cookie-div' class='btn btn-warning' href='#' style='margin-right: 10px; color: #333333;'><strong>" +
    							$.i18n._("I Understand") +
    							"</strong></a>" +
    							"<a class='btn btn-warning' style='color: #333333;' href='" + ufal.utils.get_dspace_url() +"page/cookies'><strong>" +
    		...
    		jQuery("#hide-cookie-div").on(ufal.click_event, function() {
    			document.cookie = "cookie-message=hide;path=" + new URL(ufal.utils.get_dspace_url()).pathname;
...
ufal.utils = {
    ...
    isCookieExist: function (cname, cvalue) {
    	var value = ufal.utils.getCookie(cname);
    	if (value == cvalue) {
    		return true;
    	} else {
