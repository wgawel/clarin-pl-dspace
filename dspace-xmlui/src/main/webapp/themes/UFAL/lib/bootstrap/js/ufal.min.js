...
jQuery(document)
    ...
    function () {
        ...
        jQuery('div#files_section > h4').append(jQuery('<a class="fa fa-download" aria-hidden="true" href="#" style="display:block; text-decoration:none; color:black"> script</a>').click(function(e){
            e.preventDefault();
            var command = "#Don't count on this working long term\nwhile read url\ndo\n  wget \"$url\"\ndone <<EOF\n";
            $("a.filebutton[href*='bitstream']").each(function(){
