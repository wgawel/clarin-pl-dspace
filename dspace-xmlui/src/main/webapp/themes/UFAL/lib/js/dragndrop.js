function init_dragNdrop() {
	...
	var dropZone = jQuery(
			"<li><span class='well well-large bold' id=\"drop_zone\" dropzone=\"copy\" style=\"font-size: 32px; display:block; line-height:100px; text-align:center; margin-bottom: 15px; margin-top: -20px; \">" + $.i18n._("dragndrop-drop-here") + "</span></li>")
