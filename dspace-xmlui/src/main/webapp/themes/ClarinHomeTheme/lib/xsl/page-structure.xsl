...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="dri:document">
		<html>
            ...
            <xsl:text disable-output-escaping="yes">&lt;!--[if lt IE 7 ]&gt; &lt;body class="ie6"&gt; &lt;![endif]--&gt;
                ...
                &lt;!--[if (gt IE 9)|!(IE)]&gt;&lt;!--&gt;&lt;body id="clarinpl-repository"&gt;&lt;!--&lt;![endif]--&gt;</xsl:text>
	...
	<xsl:template name="buildHead">
		<head>
			...
			<link rel="stylesheet" href="{$theme-path}/lib/clarin/public/css/clarin.css" />
            ...
            <link rel="stylesheet" href="{$theme-path}/lib/bootstrap/css/clarin-theme.css" />
	...
	<xsl:template match="dri:body">
		...
		<div class="container-fluid">
			...
			<div class="container">
				...
				<!-- Top banner with CLARIN logo -->
				<xsl:call-template name="top-banner" />
				
				<!-- A line with CLARIN-PL branding colors -->
				<div class="row hidden-xs" style="background-color: #b2aeaa; height: 1px;">&#160;</div>
	...
	<xsl:template match="dim:dim" mode="recentList-DIM-metadata">
		...
		<img class="artifact-icon pull-right" alt="{dim:field[@element='type'][1]/node()}">
			<xsl:attribute name="src">
                                <xsl:text>themes/ClarinHomeTheme/lib/images/</xsl:text>
                                <xsl:value-of
	...
	<xsl:template name="addJavascript">
		...
		<script type="text/javascript">
			<xsl:attribute name="src">
	             <xsl:value-of select="$theme-path" />
	             <xsl:text>/lib/bootstrap/js/clarin.min.js</xsl:text>
			</xsl:attribute>&#160;</script>
	...
	<xsl:template name="top-banner">
	    <div id="clarinpl-header-logo" class="row">
			...
			<div style="float: left; margin: 40px 10px 10px 25px;">
				<!--
				 <img src="{$context-path}/themes/ClarinTheme/images/clarin/clarin-logo.png" class="logo" width="200" height="50" alt="CLARIN logo" />
				 -->
			</div>
			<div style="float: left; margin: 14px 60px 14px 120px;">
		        <a href="/dspace">
	                <img src="{$context-path}/themes/ClarinTheme/images/clarin/clarin-logo.png" class="logo" alt="CLARIN logo" />
                </a>
		    </div>
			<div style="float: right; margin: 14px 15px 14px 120px;">
				<!--
				<a href="https://assessment.datasealofapproval.org/assessment_149/seal/html/">
					<img src="{$context-path}/themes/ClarinTheme/images/clarin/DSA.jpg" class="logo" width="100" height="100" alt="CLARIN logo" />
				</a>
				-->
			</div>
	    </div>	
