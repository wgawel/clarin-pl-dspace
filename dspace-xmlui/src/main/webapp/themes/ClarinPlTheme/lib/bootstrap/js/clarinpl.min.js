                        ...
                        jQuery(".licenseselector").licenseSelector(
                                {
                                        licenses: {
                                                'pcedt2': {
                                                        ...
                                                        available: true,
                                                        url: 'https://clarin-pl.eu/dspace/page/license-pcedt2',
                                                ...
                                                'cnc': {
                                                        ...
                                                        available: true,
                                                        url: 'https://clarin-pl.eu/dspace/page/license-cnc',
                                                ...
                                                'hamledt': {
                                                        ...
                                                        available: true,
                                                        url: 'https://clarin-pl.eu/dspace/page/licence-hamledt',
                                                ...
                                                'hamledt-2.0': {
                                                        ...
                                                        available: true,
                                                        url: 'https://clarin-pl.eu/dspace/page/licence-hamledt-2.0',
                                                ...
                                                'pdt2': {
                                                        ...
                                                        available: true,
                                                        url: 'https://clarin-pl.eu/dspace/page/license-pdt2',
                                                ...
                                                'pdtsl': {
                                                        name: 'PDTSL',
                                                        available: true,
                                                        url: 'https://clarin-pl.eu/dspace/page/licence-pdtsl',
...
ufal.utils = {
	...
	handle_static_pages_js : function() {
		...
		jQuery(".addDspaceContextToLink").each(function() {
			jQuery(this).attr("href", ufal.utils.get_dspace_url()+jQuery(this).attr("href"));
		});
	},
	...
	get_dspace_url : function() {
        /* TODO: get url from DSpace configuration */
        var baseUrlEndPos = document.URL.search('/xmlui');
        if (baseUrlEndPos == -1) {
            baseUrlEndPos = document.URL.search('/dspace');
        }
        if (baseUrlEndPos == -1) {
            baseUrlEndPos = document.URL.search('/repo');
        }
		var urlBegin = document.URL.substr(0, baseUrlEndPos);
        var urlEnd = document.URL.substring(baseUrlEndPos, baseUrlEndPos+2+document.URL.substr(baseUrlEndPos+1).search('/'));
