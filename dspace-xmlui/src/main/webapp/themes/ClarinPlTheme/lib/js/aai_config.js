    ...
    function () {
        var opts = (function () {
            ...
            instance.responseUrl =
                (window.location.hostname.search("dspace-dev") >= 0) ?
                        "" :
                        instance.host + instance.port + instance.repoPath +
                            "themes/ClarinPlTheme/lib/html/disco-juice.html?";
            instance.metadataFeed = instance.target + "discojuice/feeds";
            instance.serviceName = "CLARIN-PL Repository";
            instance.localauth =
                '<form method="post" action="' + instance.target + 'password-login"> ' +
                    '<p>Sign in using your local account obtained from the CLARIN-PL administrator.</p>' +
            ...
            instance.textHelpMore = "First check You are searching under the right country.\nIt is possible that our service is not connected with Your identity provider. Please contact us at <a href='mailto:dspace@clarin-pl.eu'>dspace@clarin-pl.eu</a>. We'll try to solve it with Your provider or create an account for You.";
            return instance;
        })();
        if (!("aai" in window)) {
            throw "Failed to find UFAL AAI object.";
        }
