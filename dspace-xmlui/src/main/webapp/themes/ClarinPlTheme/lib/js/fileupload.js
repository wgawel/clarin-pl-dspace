...
+ convertBytesToHumanReadableForm(clarinpl_upload_file_alert_max_file_size)
...
function processFiles(files) {
	...
	var filesToUpload = filterFiles(files, function(f) {
		return f.size <= clarinpl_upload_file_alert_max_file_size;
	});
				...
				function() {
					...
					jQuery(".checksum_cell")
							.each(
									function() {
										...
										jQuery(this)
												.html(
														"<img src='../../../../themes/ClarinPlTheme/images/information.png' />")
									});// .html("&sum;")});
					...
					if (anchor === "#fl") {
						jQuery('html, body').animate(
								{
									scrollTop : jQuery(".clarinpl-footer-main")
											.offset().top
