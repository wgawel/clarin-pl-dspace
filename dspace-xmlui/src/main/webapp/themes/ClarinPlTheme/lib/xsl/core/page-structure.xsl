...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <link rel="stylesheet" href="{$theme-path}/lib/clarinpl/public/css/clarinpl.css" media="screen" />
            ...
            <link rel="stylesheet" href="{$theme-path}/lib/bootstrap/css/clarinpl-theme.css" media="screen" />
