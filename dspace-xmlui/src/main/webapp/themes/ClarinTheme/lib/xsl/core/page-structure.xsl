...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <link rel="stylesheet" href="{$theme-path}/lib/clarin/public/css/clarin.css" media="screen" />
            ...
            <link rel="stylesheet" href="{$theme-path}/lib/bootstrap/css/clarin-theme.css" media="screen" />
