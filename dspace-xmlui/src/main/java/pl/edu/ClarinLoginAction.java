...
public class ClarinLoginAction extends AbstractAction {

    private static Logger log = Logger.getLogger( ClarinLoginAction.class);
    ...
    public Map act(Redirector redirector, SourceResolver sourceResolver, Map objectModel, String s, Parameters parameters) throws Exception {
        ...
        try {
            ...
            log.error(" ClarinLoginAction SQL Error ",ex);
        }
